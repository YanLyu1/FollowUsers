    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(request.getParameter("hide") != null){
            if(hide.equals("welcome")){
                if(option.equals("bm")){
                    mv = new ModelAndView("Part6SearchMovie");
                }else{
                    mv = new ModelAndView("Part6AddMovie");
                }
                return mv;
                ...
                mv = new ModelAndView("Part6SearchResult");
                return mv;
            }
        }else{
            mv = new  ModelAndView("Part6Welcome");
            return mv;
        }
    }
