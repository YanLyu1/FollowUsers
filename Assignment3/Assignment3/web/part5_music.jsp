...
<html>
    ...
    <body>
    <c:set var="productList" value="${productDir.products}" scope="application"/>
            ...
            <tr>
                ...
                <td style="background-color:#eeeeee;height:200px;width:400px;vertical-align:top;">
                    <form method  = "GET" action = "Part5Servlet">
                        ...
                        <br/>
                        <input type="hidden" value="musics" name="option" />
                        <input type = "submit" value = "addMusics" name = 'add Musics'/>
                    </form>
                </td>
            </tr>
        </table>
